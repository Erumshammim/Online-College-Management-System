...
<section style=" background-image:url(images/a+.jpg) ; 
   /* height: 100%;*/
...
<centre>
    ...
    font-size: 70px;
    font-weight: bolder;
    color:black;">Student Marks</h1><br><br><br>
    <div class="container">
    <?php
    $conn=mysqli_connect("localhost","root","");
    $db=mysqli_select_db($conn,'college');
    $query="SELECT studentId,term,academicYear, midGrade, finalGrade from enrollment where studentId=$login_session";
